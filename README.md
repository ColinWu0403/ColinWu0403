<h1>💫 About Me:</h1> 
<p>🎓 Hello! I'm currently a Junior at Purdue University studying in Computer Science.</p>
<p>🖥️ I can program with Java, C, C++, C#, Python, JavaScript, and PHP.</p>
<p>👾 For front-end, I have experience creating applications with React, Vue, and React Native and using HTML, CSS, JavaScript, and TypeScript. For back-end, I've created projects using Django, Rust, and ASP.NET. I am also familiar with using databases with MySQL, PostgreSQL, and MongoDB.</p>
